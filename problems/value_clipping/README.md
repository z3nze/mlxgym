...
Contract: `Clamp x to inclusive [lo, hi]`.
...
Below/at/above bounds, equal bounds, and negative-only intervals. Every GPU buffer has guard regions, output starts with a sentinel, and
